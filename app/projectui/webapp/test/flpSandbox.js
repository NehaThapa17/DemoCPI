		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample CPI Email ",
									"targetURL": "#democpiprojectui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"democpiprojectui-display": {
								"semanticObject": "democpiprojectui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.cpi.projectui",
									"url": sap.ui.require.toUrl("demo/cpi/projectui")
								}
							}
						}
					}
